...
export function AnalysisExplanation() {
    return (
        <div>
            ...
            <p>
                The right image shows the Google Sheets document after the analysis. The name of the column is the name
            ...
            <p>
                ...
                "male", "female"). Of course, these have no influence on the result of the analysis, but can be useful
